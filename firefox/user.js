...
// speeds up loading of websites; can cause Problems with some websites
user_pref("network.http.pipelining", true);
// enables pipelining only for ssl connections; avoids problems occurring with http
user_pref("network.http.pipelining.ssl", true);
// number of requests sent at once
user_pref("network.http.pipelining.maxrequests", 32);
// if a proxy is used
user_pref("network.http.proxy.pipelining", true);
// limits page reloads while reciving data; speeds up the download time
